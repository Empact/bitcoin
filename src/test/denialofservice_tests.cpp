...
BOOST_AUTO_TEST_CASE(outbound_slow_chain_eviction)
{
    ...
    auto peerLogic = MakeUnique<PeerLogicValidation>(connman.get(), nullptr, scheduler, *m_node.mempool);
...
BOOST_AUTO_TEST_CASE(DoS_banning)
{
    ...
    auto connman = MakeUnique<CConnman>(0x1337, 0x1337);
    auto peerLogic = MakeUnique<PeerLogicValidation>(connman.get(), banman.get(), scheduler, *m_node.mempool);
