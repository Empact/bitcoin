                                 ...
                                 std::set<CInputCoin>& setCoinsRet, CAmount& nValueRet, const CoinSelectionParams& coin_selection_params)
{
    ...
    if (bnb_result) {
        results.emplace_back(std::make_tuple(bnb_result->GetWaste(), bnb_result->m_selected_inputs, bnb_result->GetSelectedValue()));
    }
    ...
    if (knapsack_result) {
        results.emplace_back(std::make_tuple(knapsack_result->GetWaste(), knapsack_result->m_selected_inputs, knapsack_result->GetSelectedValue()));
    }
    ...
    if (srd_result != std::nullopt) {
        results.emplace_back(std::make_tuple(srd_result->GetWaste(), srd_result->m_selected_inputs, srd_result->GetSelectedValue()));
    }
