        ...
        bool sign) EXCLUSIVE_LOCKS_REQUIRED(wallet.cs_wallet)
{
    ...
    coin_selection_params.m_min_change_target = GenerateChangeTarget(std::llround(std::floor(recipients_sum / vecSend.size())), coin_selection_params.m_change_fee, rng_fast);
