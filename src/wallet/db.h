...
public:
    ...
    virtual bool Verify(std::vector<bilingual_str>& warnings, bilingual_str& errorStr) = 0;
...
public:
    ...
    /* verifies the environment and database file */
    bool Verify(std::vector<bilingual_str>& warnings, bilingual_str& errorStr) override;
