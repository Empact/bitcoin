...
static std::string SortedInputValueStr(const SelectionResult& result)
{
    std::vector<CAmount> amts;
    for (const auto& coin : result.GetInputSet()) {
        amts.push_back(coin.txout.nValue);
    }
    std::sort(amts.begin(), amts.end());

    std::ostringstream ostr;
    std::copy(amts.begin(), amts.end(), std::ostream_iterator<CAmount>(ostr, ", "));

    return strprintf("[%s]", ostr.str());
}
...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    BOOST_CHECK(result1);
    BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result1));
    ...
    BOOST_CHECK(result2);
    BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result2));
    ...
    BOOST_CHECK(result3);
    BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result3));
    ...
    BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result4));
    expected_result.Clear();
    ...
    BOOST_CHECK(result5);
    BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result5));
    ...
    // BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result6));
    ...
    BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result8));
    ...
    }
    {
        ...
        BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result11));
        available_coins.Clear();
        ...
        BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result12));
        available_coins.Clear();
        ...
        BOOST_CHECK_EQUAL(SortedInputValueStr(expected_result), SortedInputValueStr(*result13));
    }
}
