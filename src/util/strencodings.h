...
std::vector<unsigned char> DecodeBase64(const std::string& str, bool* pf_invalid = nullptr);
...
std::vector<unsigned char> DecodeBase32(const std::string& str, bool* pf_invalid = nullptr);
